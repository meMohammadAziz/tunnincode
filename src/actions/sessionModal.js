...
// Constants
import { add_session_modal, edit_session_modal, cancel_session_modal, cancelled_session_modal, close_modal } from '../constants/constants';
...
export const sessionModal=(type)=> {
    ...
    else if(type === edit_session_modal) {
        return {
            type: edit_session_modal,
            payload: localData.sessionModal.editedSession
        }
    }
