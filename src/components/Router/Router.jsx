        ...
        return (
            <div>
                <Switch>
                    ...
                    <Route component={Main2} path="/comments" exact />
                    ...
                    <Route
                        component={SessionDetailUser}
                        path="/session-details-user"
                        exact
                    />
                    <Route
                        component={AudioVideo}
                        path="/test-audio-video"
                        exact
                    />
                </Switch>
            </div>
